...
public interface SQLQuery {
	...
	String UPDATE_STUDENT = "UPDATE STUDENT SET PHOTO=?, DOJ=?, STUDENT_NAME=?, DOB=?, GENDER=?, NATIONALITY=?, STATE=?, RELIGION=?, CASTE=?, CASTE_CATEGORY=?, MOTHER_TOUNGE=?, FATHER_NAME=?, MOTHER_NAME=?, RESIDENCE=?, FATHER_OCCUPATION=?, FATHER_RESIDENCE=?, PHONE_NUMBER=?, SCHOOLS_PREVIOUS=?, TC_NUMBER=?, TC_DATE=?, CLASS_ADMITTED=?, MEDIUM=?, IDENTITY_MARKS=?, UPDATED_DATE=?, UPDATED_BY=? WHERE ADMISSION_NUMBER=?";
	...
	String UPDATE_VIEW_STUDENT = "UPDATE VIEW_STUDENT SET STUDENT_NAME=?, DOB=?, GENDER=?, FATHER_NAME=?, MOTHER_NAME=?, RESIDENCE=?, PHONE_NUMBER=?, CLASS_ADMITTED=?, CURRENT_CLASS=?, CASTE_CATEGORY=?, UPDATED_DATE=?, UPDATED_BY=? WHERE ADMISSION_NUMBER=?";
	...
	String IS_STUDENT_EXIST = "SELECT COUNT(1) AS COUNT FROM STUDENT WHERE ADMISSION_NUMBER=?";
	...
	String UPDATE_CLASS_TIMETABLE = "UPDATE class_timetable SET PERIOD_I=?,PERIOD_II=?,PERIOD_III=?,PERIOD_IV=?,PERIOD_V=?,PERIOD_VI=?,PERIOD_VII=?,PERIOD_VIII=?,UPDATED_DATE=?,UPDATED_BY=? WHERE CLASS=? AND DAY=?";
	...
	String IS_CLASS_EXIT = "SELECT COUNT(1) FROM class_timetable WHERE CLASS=? AND DAY=?";
	...
	String GET_PROGRESS_REPORT_OF_STUDENT = "SELECT EXAM_TYPE, CLASS, SUBJECT, MARKS, GRADEPOINT, MONTH FROM PROGRESS_REPORT WHERE ADMISSION_NUMBER=? AND EXAM_TYPE=? AND CLASS=?";
	...
	String UPDATE_PROGRESS_REPORT_OF_STUDENT = "UPDATE PROGRESS_REPORT SET MARKS=?,GRADEPOINT=?,UPDATED_DATE=?,UPDATED_BY=?,MONTH=? WHERE ADMISSION_NUMBER=? AND SUBJECT=? AND EXAM_TYPE=? AND CLASS=?";
	...
	String GET_LOGINADMIN = "SELECT USER_ID, USER_NAME, PASSWORD, ROLE, BRANCH, NAME, EMAIL FROM login_credentals WHERE USER_NAME = ?";
	String GET_ALLADMINUSERS = "";
	String ADD_LOGINADMIN = "INSERT INTO login_credentals(USER_NAME, PASSWORD, ROLE, BRANCH, NAME, EMAIL) VALUES (?,?,?,?,?,?)";
	...
	String GET_ALL_MARKS_BY_CLASS_ADNO = "SELECT EXAM_TYPE,SUBJECT,MARKS,GRADEPOINT FROM PROGRESS_REPORT WHERE ADMISSION_NUMBER=? AND CLASS=? ORDER BY EXAM_TYPE ";
}
