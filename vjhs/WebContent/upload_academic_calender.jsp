...
<script type="text/javascript">
	...
	function nameCheck() {
		...
		$(function() {
			...
			$
					.ajax({
						url : 'getAcademicCalendarFiles.upload',
						dataType : 'xml',
						cache : false,
				...
				<div class="viewFull">
					<center>
						<form method="post" action="academic.upload"
							...
							<label class="headerCreatePage">Select Academic calendar
								file to upload:</label> <input type="file" id="fileToUpload"
								name="uploadFile" width="20" height="20" onchange="nameCheck();" />
							<br> <input type="submit" value="Upload" /> <br> <br>
						</form>
