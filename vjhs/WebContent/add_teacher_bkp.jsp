							...
							<fieldset>
								...
								<div class="fulWidth">
									<label class="leftLabel"><fmt:message key="DOB" /></label> <label
										class="rightLabel"><input class="inputType"
										type="date" name="dob" id="dob" required class="datepicker"
										readonly="readonly" placeholder="Enter Teacher's DOB"
								...
								<div class="fulWidth">
									...
									<label class="rightLabel"><select class="selectType"
										id="gender" name="gender">
											<option value="select"
												<c:if test="${sessionScope.teacher==null}">selected</c:if>><fmt:message
