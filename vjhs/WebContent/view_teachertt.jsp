...
<title>VJHS:: View Teacher Time Table</title>
					...
					<div class="viewCRight">
						<div>
							<form name="updateCTable" method="post" id="updateCTable"
								...
								<div>&nbsp;</div>
								<div>
									<label>Please select Teacher to get Time Table :&nbsp;</label>
									<span class="classNamePlace"> <select name="teacherName"
										id="teacherName" onchange="onChangeTeacher()">
